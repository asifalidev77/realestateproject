  ...
  return (
    <>
      <div className="bg-none flex h-[20vh] px-[20px] md:px-[50px] lg:px-[86px] w-full items-center justify-between relative">
        ...
        <Link  href="/" >  <Image src={logoBlack} width={194} height={135.43} alt="Black logo" />
        </Link>
        </div>
            ...
            >
              ...
              {isDropdownOpen && (
                <ul className=" bg-[#2B4463] text-white  py-2 px-3 absolute w-[200px] h-[80px] mt-[10px] p-[30px] rounded-[10px] ">
                 <Link href= "/services/Construction-Services">  <li className='hover:!text-[#FF9D00]' >Construction</li></Link> 
                 <Link href="/services/selling-and-purchasing-services"> <li className='hover:!text-[#FF9D00]'>Selling & Purchasing</li> </Link>
                </ul> 
              )}
            </li>
